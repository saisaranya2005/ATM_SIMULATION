...
public class Webgoal extends JFrame implements ActionListener {
	JButton search;
	 private String filePath = "D:\\22BEC1059\\ATM\\src\\ATM\\goaltracker.html";
	Webgoal() {
		...
		JLabel text = new JLabel("Have a goal? then track it");
		...
		search = new JButton("Enter to chase your goal");
